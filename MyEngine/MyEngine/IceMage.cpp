...
IceMage::IceMage()
{
	...
	Texture* animTex = LOAD_TEXTURE(L"IceMageAnimTex", L"Texture\\Monster\\IceMageAnim.bmp");
	Texture* hitAnimTex = LOAD_TEXTURE(L"IceMageHitAnimTex", L"Texture\\Monster\\IceMageHitAnim.bmp");
