	...
	, mDelayTime(0.f)
{
	...
	Texture* deg0Tex = LOAD_TEXTURE(L"LockedDoor_0Deg_Tex", L"Texture\\DungeonObject\\LockedDoor_0Deg_Anim.bmp");
	Texture* deg90Tex = LOAD_TEXTURE(L"LockedDoor_90Deg_Tex", L"Texture\\DungeonObject\\LockedDoor_90Deg_Anim.bmp");
	Texture* deg270Tex = LOAD_TEXTURE(L"LockedDoor_270Deg_Tex", L"Texture\\DungeonObject\\LockedDoor_270Deg_Anim.bmp");
